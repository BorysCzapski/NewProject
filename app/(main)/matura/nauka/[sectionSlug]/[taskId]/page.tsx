...
import type { MaturaSectionSlug, MaturaTask } from "@/lib/types/database";
...
export default async function MaturaSectionTaskPage({
  ...
  return (
    <div>
      <PageHeader title="Matura Angielski" />
      <div className="mx-auto max-w-lg px-5 py-5">
        ...
        <TaskAttemptForm task={task as MaturaTask} backHref={backHref} />
      </div>
    </div>
  );
}
