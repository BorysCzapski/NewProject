// ============================================================================
// components/geografia/dashboard/progress-trend-chart.tsx
// Plain SVG line chart of estimated mastery % over time — no chart library
// installed, same approach as components/matma/dashboard/progress-trend-chart.tsx.
// ============================================================================
...
export function ProgressTrendChart({ snapshots }: { snapshots: GeoProgressSnapshot[] }) {
  return (
    <Card className="flex flex-col gap-3">
      <CardTitle>Trend postępów w czasie</CardTitle>
      {snapshots.length < 2 ? (
...
function TrendSvg({ snapshots }: { snapshots: GeoProgressSnapshot[] }) {
  ...
  return (
    <div className="text-primary">
      <svg
        ...
        className="w-full"
        role="img"
        aria-label="Wykres trendu poziomu opanowania materiału w czasie"
      >
        <polyline
