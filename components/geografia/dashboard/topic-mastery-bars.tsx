// ============================================================================
// components/geografia/dashboard/topic-mastery-bars.tsx
// Dashboard department overview: one row per topic (order_index order),
// mastery bar + percent + status badge. Mirrors components/matma/dashboard/
// topic-mastery-bars.tsx exactly (same status label/color mapping).
// ============================================================================
  ...
  return (
    <Card className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        {topics.map((topic) => (
          <Link key={topic.id} href={`/geografia/tematy/${topic.slug}`} className="block">
